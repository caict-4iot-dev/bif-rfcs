...
随着星火链网的发展和相关软件的开放开源，现需要一套意见征集机制，称为星火链网共识意见征集稿，简称星火链网RFCs，目标是面向广大星火链网的使用者和开发者，鼓励他们根据星火链网RFC标准，积极提出对星火链网的改进意见，促进星火链网生态的蓬勃发展。
...
因此，用户在使用星火链网相关内容时，必须格外关注已通过的星火链网RFCs和相关更新。
...
> 注：因建议类RFC不需要提供实现，此RFC的生命周期不包括演示阶段。
...
提交：将完整RFC文档提交至星火链网GitHub，从次日起在星火链网Gitee/GitHub上进行至少为期三个月的讨论；
...
结束：RFC被撤回后，只更改其状态为撤回，原文档仍保留在星火链网GitHub上。
