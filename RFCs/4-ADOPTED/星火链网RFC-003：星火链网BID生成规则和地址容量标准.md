...
1 / ( 2<sup>160</sup> ) //"2<sup>160</sup>"意思是2的160次方，由于每次碰撞至少需要3次SHA-256运算。当前比特币全网每秒的算力（ E =(130 EH/s) 1.3*10<sup>20</sup>为当前比特币全网算力，比特币算力统计链接[https://btc.com/](https://btc.com/)）进行破解。那么，每秒碰撞该地址成功的概率：
...
#### <span id="jump24">2.1.3 BID地址碰撞</span>
